//功能优势板块切换
var i_one = $(".edge_sub .on").index();
var i_one_max = $(".edge_sub li").length - 1;
//滑动切换
function jumpOne(x){
    i_one = i_one + x;
    ...
    $(".edge_list").css("left", i_one * -720 / 75 + "rem");
    $(".edge_sub li").eq(i_one).addClass("on").siblings().removeClass("on");
}

$(".edge_window").on("touchstart", function(e){
    //touchstart事件
    var that = $(this);
